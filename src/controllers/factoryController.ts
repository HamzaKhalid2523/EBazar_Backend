...
exports.deleteOne = (Model: any, logOptions: any = {}, popOptions: any) =>
...
exports.deleteMany = (Model: any, logOptions: any = {}, popOptions: any) =>
    catchAsync(async (req: any, res: Response, next: NextFunction) => {
        let docPromise = Model.deleteMany({_id: req.body.ids});
...
exports.updateOne = (Model: any, logOptions: any = {}, popOptions: any) =>
    catchAsync(async (req: any, res: Response, next: NextFunction) => {
...
exports.createOne = (Model: any, logOptions: any = {}, popOptions: any) =>
    catchAsync(async (req: any, res: Response, next: NextFunction) => {
        let query: any = req.query;
        let body = {
            ...req.body,
...
exports.getAll = (Model: any, popOptions: any, unique_actions: any) =>
    catchAsync(async (req: any, res: Response, next: NextFunction) => {
        ...
        console.log(dataPromise.queryFilters);
